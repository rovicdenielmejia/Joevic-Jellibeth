  ...
  return (
    <div className="bg-cream-50 rounded-2xl p-5 border border-border shadow-soft card-hover animate-fade-in-up">
      ...
      <button
        ...
        className="w-full mt-4 py-3 px-4 bg-mint-100/65 border border-border hover:bg-mint-200 text-primary font-medium text-sm rounded-xl transition-colors flex items-center justify-center gap-2"
      >
